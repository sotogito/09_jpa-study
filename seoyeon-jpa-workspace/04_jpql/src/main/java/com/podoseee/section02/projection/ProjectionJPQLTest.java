...
public class ProjectionJPQLTest {
    ...
    public void 임베디드_프로젝션_테스트(){
        String jpql = "SELECT m.menuInfo FROM menu2 WHERE m.menuCode = 5";
    ...
    public void new_DTO_프로젝션_테스트(){
        ...
        String jpql = "SELECT new com.podoseee.section02.projection.CategoryResponseDto(c.categoryCode, c.categoryName) FROM category2 c";
