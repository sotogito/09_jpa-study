...
public class EntityLifeCycleTest {
    ...
    public void 비영속_테스트(){
        ...
        /*
            ...
            ┌--------------------------------|----------------------------------------------------------------------┐
            │          │         │           |    Menu                       │        │  Menu                       │
            │  0X1000  │  ....   │  0X2000   |   (menuCode=3,                │  ....  │ (menuCode=3,                │
            │          │         │           |    menuName=생갈치쉐이크, ..) │        │  menuName=생갈치쉐이크, ..) │
            └--------------------------------|----------------------------------------------------------------------┘
              newMenu           foundedMenu  |
         */
    ...
    public void 영속_find_테스트(){
        ...
        /*
            ...
            ┌---------- Persistence Context ----------┐   ┌-----------------------------------┐
            │                                         │   │                                   │
            │           Menu(menuCode=3, xx)          │◀--│        SELECT FROM WHERE          │
            │                                         │   │                                   │
            └-----------------------------------------┘   └-----------------------------------┘
         */
         ...
         */
         ...
         /*
            ...
            ┌--------------------------------|---------------------------------┐
            │          │         │           |    Menu                         │
            │  0X1000  │  ....   │  0X1000   |   (menuCode=3,                  │
            │          │         │           |    menuName=생갈치쉐이크, ..)   │
            └--------------------------------|---------------------------------┘
            foundedMenu1        foundedMenu2 |
         */
    ...
    public void 준영속_merge_update_테스트(){
        ...
        // 1) foundedMenu의 식별자(1)를 가지고 1차 캐시로부터 조회 (존재하지 않아 DB로 부터 조회)
